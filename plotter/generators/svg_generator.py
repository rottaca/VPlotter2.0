...
class SVGGenerator(generator_base.GeneratorBase):
    ...
    def setupCustomParams(cls, subparser):
        subparser.add_argument('--path-sampling', default=30, type=int, help="Number of samples taken from each path object. High number increases precision but also print time.")
